...
import static io.realworld.backend.app.dto.Mappers.toProfileResponse;
...
@Service
@Transactional
public class ProfileApplicationService extends BaseService implements ProfilesApiDelegate {
